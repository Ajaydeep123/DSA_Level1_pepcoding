...
public class Main {
  ...
  public static class BSTPair{  // every node will have these three things.
    int min;
    int max;
    boolean isBST;
  }
  ...
  public static BSTPair isbst(Node node){
    ...
    if(node== null){
      ...
      bp.min= Integer.MAX_VALUE;   // isme infinity store hojaega toh jb kisi dusri value se compare karenge toh woh value hmesha minimum hi hogi.
